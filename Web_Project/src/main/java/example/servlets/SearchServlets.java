...
public class SearchServlets extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String deptNo = request.getParameter("deptNo");// get parameter html
...
//			out.println("<h2>Found</h2>");
			dispatcher = request.getRequestDispatcher("showDept");// showdeptServlet call
			request.setAttribute("loadedDept", foundDept);
